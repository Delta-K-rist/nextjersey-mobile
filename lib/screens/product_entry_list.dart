...
import 'package:nextjersey/models/product_entry.dart';
import 'package:nextjersey/widgets/left_drawer.dart';
import 'package:nextjersey/screens/product_detail.dart';
import 'package:nextjersey/widgets/product_entry_card.dart';
...
class _ProductEntryListPageState extends State<ProductEntryListPage> {
  Future<List<ProductEntry>> fetchNews(CookieRequest request) async {
    ...
    final response = await request.get(
      'https://deltakristiano-kurniaputra-nextjersey.pbp.cs.ui.ac.id/json/',
    );
